...
.const E_T T_BAREWORD   ; subsequent letter
.const E_U T_BAREWORD   ; subsequent digit

.const E_H T_NUM    ; first digit
.const E_V T_NUM    ; subsequent digit

.const E_I T_EOF

.const E_J EMIT_CHAR    ; P = <operpunc>
.const E_W T_TERN1

.const E_X T_IDENT  ; sigil + 1 char
.const E_AA T_IDENT
.const E_AB T_IDENT

.const E_M T_IGNORE ; whitespace
.const E_Y T_IGNORE ; ditto
